...
def pmf(trains, tests, sigma=0.00001, lamb_u=0.01, lamb_v=0.001, latent_d=10, learning_r=0.0003, limit=1000000, verbose=True):
    """
        ...
        for lamb_v in lamb_vs:
            for learn_r in learn_rs:
                for latent_d in latent_ds:
                    ...
                    rmses, Us, Vs = pmf(train, test, sigma=sigma, latent_d=latent_d, lamb_u=lamb_u, lamb_v=lamb_v, learning_r=learn_r, limit=limit)
